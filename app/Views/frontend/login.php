<div class="container divLoginContainer">
    <div class="text-center mb-5">
        <h1 class="display-4">Cabañas El Campito</h1>
        <p class="lead">Una Experiencia Inolvidable</p>
    </div>
        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('/login') ?>">
                <div class="mb-3">
                    ...
                    <input name="usuario" type="text" class="form-control" id="loginEmail"
            ...
            <p class='text-center p-3'>No tienes una cuenta ? <span><a
                        href="<?= base_url('/registro') ?>">Registrate</a></span></p>
        </div>
    </div>
</div>